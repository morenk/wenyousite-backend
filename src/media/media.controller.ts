...
import { ConfirmUploadResponseDto, MediaResponseDto, UploadUrlResponseDto } from './dto/media-response.dto';
...
export class MediaController {
  ...
  @ApiCreatedResponse({ type: UploadUrlResponseDto, description: '预签名 URL 和 mediaId（UPLOADING 状态）' })
  ...
  @ApiOkResponse({ type: MediaResponseDto, description: '图片处理状态（UPLOADING / PROCESSING / COMPLETED / FAILED）' })
  @ApiUnauthorizedResponse({ description: '未登录或 Token 无效' })
